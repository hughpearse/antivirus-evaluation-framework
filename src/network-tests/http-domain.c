/* Title: Send HTTP request to known malicious domain
   Known bad domains can be found on this list: https://isc.sans.edu/feeds/suspiciousdomains_High.txt
   Compile: wine gcc.exe network-tests/http-domain.c -lws2_32 -o bin/http-domain.exe
*/
...
char USERAGENT[] = "Mozilla/5.0 (Windows NT 6.1; Trident/7.0; rv:11.0) like Gecko";
